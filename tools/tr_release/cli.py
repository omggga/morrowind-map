...
def _assert_future_dataset_id(dataset_id: str, index_path: Path) -> None:
    ...
    if len(identifiers) not in (2, 3, 4, 5) or identifiers.count(ORIGINAL_DATASET_ID) != 1:
        raise ValueError("Active dataset index must contain two to five maps including Original")
